...
import errno
import os
from .dice_coefficient import multiclass_dice_coeff, build_target
...
class ConfusionMatrix(object):
    ...
    def compute(self):
        ...
        # recall 0.0
        sensitivity = np.diag(hist) / np.maximum(hist.sum(1), 1)
        ...
        return miou, sensitivity, Precision,acc_global,acc,
    ...
    def __str__(self):
        miou, recall, Precision ,acc_global,acc= self.compute()
        return (
            '==========================================\n'
            'mean iou: {:.3f}\n'
            'recall: {}\n'
